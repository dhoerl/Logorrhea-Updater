...
A: Read the Logarrhea licence. People may download and use the code for their own use, but are not allowed to redistribute it.
...
A: No idea. I have tried for close to 5 years now to get them to take my fixes, for a while they chatted, but in the last year the line has gone dead.

Q: So, if I run your script on my computer, can I then redistribute the source or binary?
A: Well, read their license agreement. I personally do not believe you can legally do either.

Q: Why shouldn't I just use their original binary?
A: Well, it does still work. A few bugs prevent it from seeing all text in all chats, so you find yourself failing to find some bit of information that you know is in some chat (this is how I found some bugs!)
